### Same as the normal contour script,  but it adds the geographic name to the title
...
station_namer <- function(station){
  ...
  if(station == "KSBP01"){
    ...
    station_name <<- "UNKNOWN - Check station title"
  }
}

# What station(s) do you want figures from? Scales will be the same for all
# stations <- c("KSBP01",
#               "NSEX01",
#               "JSUR01",
#               "KSSK02",
...
# save_folder <- paste0(here("Figures", station),"/")

# Select years to plot - scales will be the same for all years
min_yoi <- 2022  # first year to plot
max_yoi <- 2024 # last year to plot
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      labs(x = "", y = "Depth (m)", fill = expression(degree*C), 
           title = paste(yoi, station_name, "temperature anomaly"))
    ggsave(paste0(save_folder, station, "_", yoi, "_", 
                  "T_anomaly_contour.png"), 
           dpi = 600, height = 2, width = 8)
  }
}

#### Salinity anomaly contour plot ####
# Note that the limit calculation excludes the top 5 m due to scaling issues
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      labs(x = "", y = "Depth (m)", fill = "PSU", 
           title = paste(yoi, station_name, "salinity anomaly"))
    ggsave(paste0(save_folder, station, "_", yoi, "_", 
                  "S_anomaly_contour.png"), 
           dpi = 600, height = 2, width = 8)
  }
}
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      labs(x = "", y = "Depth (m)", fill = "mg/L", 
           title = paste(yoi, station_name, "DO anomaly"))
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      {if(yoi == 2020) geom_rect(xmin = yday("2020-03-24"), 
                                 ...
                                 fill = "gray")} + 
      labs(x = "", y = "Depth (m)", 
           title = paste(yoi, station_name, "temperature"), 
...
limit_data <- anomaly_data %>% 
  filter(Year >= min_yoi, Year <= max_yoi, BinDepth <= 50)
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      {if(yoi == 2020) geom_rect(xmin = yday("2020-03-24"), 
                                 ...
                                 fill = "gray")} + 
      labs(x = "", y = "Depth (m)", 
           title = paste(yoi, station_name, "temperature - surface"), 
           fill = expression( degree*C))
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      {if(yoi == 2020) geom_rect(xmin = yday("2020-03-24"), 
                                 ...
                                 fill = "gray")} + 
      labs(x = "", y = "Depth (m)", fill = "PSU", 
           title = paste(yoi, station_name, "salinity"))
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      {if(yoi == 2020) geom_rect(xmin = yday("2020-03-24"), 
                                 ...
                                 fill = "gray")} + 
      labs(x = "", y = "Depth (m)", fill = "PSU", 
           title = paste(yoi, station_name, "salinity - surface"))
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      labs(x = "", y = "Depth (m)", fill = expression(kg/m^3), 
           title = bquote(.(yoi)~.(station_name)~sigma[Theta]))
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      {if(yoi == 2020) geom_rect(xmin = yday("2020-03-24"), 
                                 ...
                                 fill = "gray")} + 
      labs(x = "", y = "Depth (m)", fill = expression(kg/m^3), 
           title = bquote(.(yoi)~.(station_name)~sigma[Theta]~-surface))
  ...
  for (yoi in min_yoi:max_yoi) {
    ...
    ggplot(data = data_to_plot) + 
      ...
      {if(yoi == 2020) geom_rect(xmin = yday("2020-03-24"), 
                                 ...
                                 fill = "gray")} + 
      labs(x = "", y = "Depth (m)", 
           title = paste(yoi, station_name, "dissolved oxygen"), 
           fill = "mg/L")
...
for (station in stations) {
  ...
  data_to_plot <- anomaly_data %>% 
    filter(Year %in% min_yoi:max_yoi, 
           ...
           BinDepth <= max_depth, 
           Locator == station) %>% 
    mutate(Date = as.Date(paste(Year, Month, day(Date), sep = "-"))) %>% 
  ...
  ggplot(data = data_to_plot) + 
    ...
    geom_rect(xmin = yday("2020-03-24"), 
              ...
              fill = "gray") + 
    labs(x = "", y = "Depth (m)", 
         title = paste0(min_yoi, "-", max_yoi, " ", station_name, " dissolved oxygen"), 
         fill = "mg/L")
...
DO_count <- anomaly_data %>% 
  mutate(Year = year(Date), 
         Month = month(Date)) %>% 
  filter(Year %in% min_yoi:max_yoi) %>% 
  group_by(Locator, Year, Month) %>% 
